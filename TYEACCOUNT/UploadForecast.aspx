<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site1.Master" CodeBehind="UploadForecast.aspx.vb" Inherits="TYEACCOUNT.WebForm6" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="note1" class="note">
        1.sheet name must be "Plan Sale by Class"
    </div>
</asp:Content>
